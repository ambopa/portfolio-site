...
export default function Header() {
  ...
  return (
    <header className="flex flex-col gap-6 py-6 text-[12px] font-light leading-[1.4] md:flex-row md:items-start md:gap-8">
      ...
      <div ref={col2Ref}>
        <p>Строю дизайн-стратегию под бизнес-цели с учётом зрелости продукта и выстраиваю дизайн-процессы</p>
        <p>в кросс-функциональной команде. А так-же: приоритизирую, провожу исследования</p>
